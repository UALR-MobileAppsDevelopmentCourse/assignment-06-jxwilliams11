...
import com.ualr.recyclerviewassignment.Utils.AdapterList;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initComponent() {
        ...
        mAdapterList = new AdapterList(this,itemList);
        recyclerView.setAdapter(mAdapterList);

        mAdapterList.setOnItemClickListener(new AdapterList.OnItemClickListener() {
            @Override
            ...
            public void OnThumbnailClick(View view, Inbox obj, int position) {
                if(obj.isSelected())
                    mAdapterList.deleteItem(position);
            }
        });
        ...
        mFAB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mAdapterList.addItem(0, DataGenerator.getRandomInboxItem(getApplicationContext()));
                mAdapterList.notifyItemChanged(0);
